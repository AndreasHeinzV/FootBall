...
class DependencyProvider
{
    ...
    public function fill(Container $container): void
    {
        ...
        $container->set(
            DatabaseBusinessFacade::class,
            new DatabaseBusinessFacade(
        ...
        $container->set(
            PasswordLoginValidation::class,
            new PasswordLoginValidation(
                $container->get(UserAuthentication::class),
            )
        );
        $container->set(
            UserLoginValidation::class,
        ...
        $container->set(
            UserFavoriteEntityManager::class,
            new UserFavoriteEntityManager(
                $container->get(ORMSqlConnector::class),
            )
        );
        $container->set(
            ApiRequesterFacade::class,
            new ApiRequesterFacade(
        ...
        $container->set(
            FootballBusinessFacade::class,
            new FootballBusinessFacade(
        ...
        $container->set(
            UserFavoriteBusinessFacade::class,
            new UserFavoriteBusinessFacade(
                $container->get(Favorite::class),
                $container->get(UserFavoriteRepository::class)
            )
        );
        $container->set(
            UserRegisterValidation::class,
        ...
        $container->set(
            UserRegisterBusinessFacade::class,
            new UserRegisterBusinessFacade(
        ...
        $container->set(
            UserLoginBusinessFacade::class,
            new UserLoginBusinessFacade(
        ...
        $container->set(
            UserPasswordResetEntityManager::class,
            new UserPasswordResetEntityManager(
                $container->get(ORMSqlConnector::class),
            )
        );
        ...
        $container->set(
            ValidateResetErrors::class,
            new ValidateResetErrors(
        ...
        $container->set(
            ResetErrorDtoProvider::class,
            new ResetErrorDtoProvider(
                $container->get(ValidateResetErrors::class),
            )
        );

        $container->set(
            EmailCoordinator::class,
            new EmailCoordinator(
        ...
        $container->set(
            PasswordResetBusinessFacade::class,
            new PasswordResetBusinessFacade(
        ...
        $container->set(
            PasswordFailedController::class,
            new PasswordFailedController(
